...
def gen_states(
    grid: Grid, blizzards: List[Blizzard]
) -> Tuple[List[Grid], List[List[Blizzard]]]:
    ...
    return grid_states, blizzard_states


def find_shortest_path(
    grid_states: List[Grid],
    blizzard_states: List[List[Blizzard]],
    start: complex,
    end: complex,
    curr_step: int = 0,
) -> int:
...
grid_states, blizzard_states = gen_states(grid, blizzards)

shortest_path = find_shortest_path(grid_states, blizzard_states, start, end)
# print(shortest_path)
shortest_path = find_shortest_path(
    grid_states, blizzard_states, end, start, shortest_path
)
# print(shortest_path)
shortest_path = find_shortest_path(
    grid_states, blizzard_states, start, end, shortest_path
)
print(shortest_path)
