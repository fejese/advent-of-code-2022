...
min_height_distances = [
    distances_from_end[y][x]
    for y in range(H)
    for x in range(W)
    if height_map[y][x] == 0 and distances_from_end[y][x] is not None
]

print(min_height_distances)

print(min(min_height_distances))
